...
resource "aws_s3_object" "nzb_nzbsu_archive" {
...
resource "aws_lambda_function" "nzb_nzbsu" {
  ...
  s3_bucket         = aws_s3_object.nzb_nzbsu_archive.bucket
  s3_key            = aws_s3_object.nzb_nzbsu_archive.key
...
output "nzb_nzbsu_function_name" {
  value       = aws_lambda_function.nzb_nzbsu.function_name
  description = "Function name of the \"nzb-nzb_nzbsu\" lambda"
}
